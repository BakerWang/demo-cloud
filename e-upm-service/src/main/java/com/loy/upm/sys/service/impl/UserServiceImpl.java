...
public class UserServiceImpl {
    ...
    public Page<UserEntity> queryPage(@ApiIgnore UserQueryParam userQueryParam,
            @ApiIgnore Pageable pageable) {

        Page<UserEntity> page = userRepository.queryUserPage(userQueryParam, pageable);
    ...
    public SuccessResponse save(UserEntity userEntity) {
        ...
        String password = defaultPasswordService.buildDefaultPassword();
    ...
    public void update(@ApiIgnore UserEntity userEntity) {
        ...
        oldUserEntity.setEnabled(userEntity.getEnabled());
        Set<RoleEntity> roles = new HashSet<RoleEntity>();
